...
| `odh-style`            | parallel   | PatternFly priority order, wrapper compliance, class naming, hardcoded tokens (ODH-specific)                            |
| `odh-rbac`             | parallel   | Missing SSAR gates, fail-open patterns, isAdmin misuse, graceful degradation (ODH-specific)                             |
| `odh-jira-eval`        | parallel   | Jira acceptance criteria coverage — PASS/PARTIAL/MISS per criterion (ODH-specific)                                      |
